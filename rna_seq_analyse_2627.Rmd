...
Voor het genereren van de count table zijn de zes BAM-bestanden van lever- en breinsamples geanalyseerd met de functie featureCounts() uit het Rsubread pakket, waarbij gebruik is gemaakt van de ingebouwde hg38 RefSeq annotatie. Er is gekozen voor useMetaFeatures = TRUE zodat reads op genniveau worden samengevoegd, wat aansluit bij het doel om genexpressie tussen weefsels te vergelijken. De parameter strandSpecific = 0 is ingesteld omdat de libraries niet streng strand-specifiek zijn voorbereid, waardoor reads van beide DNA-strengen mogen worden meegeteld. Daarnaast is isPairedEnd = FALSE gebruikt omdat de data uit single-end sequencing bestaat. Door meerdere threads te gebruiken is de telling efficiënt uitgevoerd.
...
Uit de correlatieheatmap blijkt dat replicaten van hetzelfde weefsel sterk met elkaar correleren, terwijl de correlatie tussen lever- en breinsamples duidelijk lager is. Dit wijst op consistente expressiepatronen binnen elk weefsel en duidelijke biologische verschillen tussen de twee weefsels.

De PCA bevestigt dit patroon. De samples clusteren op basis van weefseltype, waarbij lever- en breinsamples duidelijk van elkaar gescheiden zijn langs PC1. Aangezien PC1 meer dan de helft van de totale variantie verklaart, kan worden geconcludeerd dat het grootste deel van de variatie in de dataset wordt bepaald door het verschil tussen lever- en breinweefsel.
